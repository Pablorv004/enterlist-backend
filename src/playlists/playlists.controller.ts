...
export class PlaylistsController {
  ...
  updateSubmissionFee(
    ...
    return this.playlistsService.update(id, {
      submission_fee: body.submission_fee,
    });
  }
  @UseGuards(
    JwtAuthGuard,
  ...
  @Ownership({ model: 'playlist', userField: 'creator_id' })
  @Put(':id/genre')
  updateGenre(@Param('id') id: string, @Body() body: { genre: string }) {
  ...
  @Post('sync/:userId')
  syncPlaylists(@Param('userId') userId: string, @Req() req: any) {
