  ...
  async create(createAdminActionDto: CreateAdminActionDto) {
    ...
    if (admin.role !== 'admin') {
      throw new NotFoundException(
        `User with ID ${admin_user_id} is not an admin`,
      );
    }
    ...
    if (target_user_id) {
      ...
      if (!targetUser) {
        throw new NotFoundException(
          `Target User with ID ${target_user_id} not found`,
        );
      }
    }
    ...
    if (target_playlist_id) {
      ...
      if (!targetPlaylist) {
        throw new NotFoundException(
          `Target Playlist with ID ${target_playlist_id} not found`,
        );
      }
    }
    ...
    if (target_song_id) {
      ...
      if (!targetSong) {
        throw new NotFoundException(
          `Target Song with ID ${target_song_id} not found`,
        );
      }
    }
